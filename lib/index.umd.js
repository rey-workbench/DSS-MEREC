(function (global, factory) {
    ...
    function validateDecisionMatrix(matrix, criteria) {
        ...
        const n = ((_a = matrix[0]) === null || _a === void 0 ? void 0 : _a.length) || 0;
        if (m === 0 || n === 0) {
    ...
    function validateNormalizedMatrix(normalizedMatrix) {
        ...
        const n = ((_a = normalizedMatrix[0]) === null || _a === void 0 ? void 0 : _a.length) || 0;
        for (let i = 0; i < m; i++) {
            for (let j = 0; j < n; j++) {
    ...
    function calculateOverallPerformance(normalizedMatrix, epsilon = 1e-10) {
        ...
        const n = ((_a = normalizedMatrix[0]) === null || _a === void 0 ? void 0 : _a.length) || 0; // jumlah kriteria
        if (m === 0 || n === 0) {
    ...
    function validateRemovalPerformance(removalPerformances) {
        ...
        const n = ((_a = removalPerformances[0]) === null || _a === void 0 ? void 0 : _a.length) || 0;
        for (let i = 0; i < m; i++) {
    ...
    function calculateAbsoluteDeviations(performances, removalPerformances) {
        ...
        const n = ((_a = removalPerformances[0]) === null || _a === void 0 ? void 0 : _a.length) || 0; // jumlah kriteria
        // Validasi input
        if (m === 0) {
            throw new Error("Array kinerja keseluruhan tidak boleh kosong");
        }
    ...
    function calculateMerecWeights(matrix, criteriaTypes) {
        ...
        const m = matrix.length; // jumlah alternatif
        const n = ((_a = matrix[0]) === null || _a === void 0 ? void 0 : _a.length) || 0; // jumlah kriteria
