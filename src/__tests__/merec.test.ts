import { calculateMerecWeights } from "../merec";
import { CriteriaType } from "../types";

describe("MEREC Function", () => {
  it("should calculate weights using calculateMerecWeights function", () => {
    const matrix = [
      [8, 7, 6, 5],
      [6, 8, 7, 6],
      [7, 6, 8, 7],
  ...
  it("should throw error with empty matrix", () => {
    expect(() => {
      calculateMerecWeights([], ["benefit"] as CriteriaType[]);
  ...
  it("should throw error with empty criteria types", () => {
    const matrix = [[1, 2, 3]];
    expect(() => {
      calculateMerecWeights(matrix, [] as CriteriaType[]);
    }).toThrow("Tipe kriteria tidak boleh kosong");
  });

  it("should throw error when matrix columns don't match criteria length", () => {
    const matrix = [[1, 2, 3]];
    const criteriaTypes: CriteriaType[] = ["benefit", "benefit"];

    expect(() => {
      calculateMerecWeights(matrix, criteriaTypes);
    }).toThrow(
  ...
  it("should throw error when matrix rows have inconsistent lengths", () => {
    ...
    const criteriaTypes: CriteriaType[] = ["benefit", "benefit", "cost"];
  ...
  it("should handle single criterion", () => {
    ...
    const criteriaTypes: CriteriaType[] = ["benefit"];
  ...
  it("should handle mix of benefit and cost criteria", () => {
    ...
    const criteriaTypes: CriteriaType[] = ["benefit", "cost", "benefit"];
  ...
  it("should produce consistent results with same input", () => {
    ...
    const weights1 = calculateMerecWeights(matrix, criteriaTypes);
    const weights2 = calculateMerecWeights(matrix, criteriaTypes);
